      ...
      <Popover
        content={
          <div className="w-full rounded-md bg-white p-2 sm:w-56">
            ...
            <button
          className="relative flex w-full items-center justify-start space-x-2 rounded-md p-2 text-left text-sm text-black transition-all duration-75 hover:bg-gray-100"
          onClick={() => signOut()}
        >

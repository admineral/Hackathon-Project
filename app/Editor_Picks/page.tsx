        ...
        <div className="text-white">
          <div className="container mx-auto px-4">
            ...
            {articles.map((article, index) => (
                <div key={article.id} className={`flex-none w-1/2 sm:w-1/4 md:w-80 rounded-lg overflow-hidden shadow-lg bg-gray-800 text-white ${index !== articles.length - 1 ? 'sm:mr-4' : ''} border border-gray-500`}>

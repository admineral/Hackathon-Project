...
export default function EditorPicks() {
    ...
    <div key={article.id} className={"flex-none w-1/2 sm:w-1/2 md:w-1/4 lg:w-80 rounded-lg overflow-hidden shadow-lg bg-gray-800 text-white border border-gray-500"}>
